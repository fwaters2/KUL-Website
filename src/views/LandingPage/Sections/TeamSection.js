...
import hannah from "assets/img/faces/Hannah.jpg";
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                Eric Lai
                <br />
                <small className={classes.smallTitle}>Killa Bees</small>
              </h4>
              <CardBody>
              ...
              <CardFooter className={classes.justifyCenter}>
                <Button
                  ...
                  href="https://www.facebook.com/eric.lai.378"
                  target="_blank"
                >
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                Hannah Gilbert
                <br />
                <small className={classes.smallTitle}>Discos</small>
              </h4>
              <CardBody>
                <p className={classes.description}>
              ...
              <CardFooter className={classes.justifyCenter}>
                <Button
                  ...
                  color="transparent"
                  className={classes.margin5}
                  href="https://www.facebook.com/hannah.gilbert.370"
                  target="_blank"
                >
                  <i className={classes.socials + " fab fa-facebook"} />
                </Button>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                John Kearle
                <br />
                <small className={classes.smallTitle}>Discl3xia</small>
              </h4>
              <CardBody>
                <p className={classes.description}>
              ...
              <CardFooter className={classes.justifyCenter}>
                <Button
                  ...
                  color="transparent"
                  className={classes.margin5}
                  href="https://www.facebook.com/john.c.kearle"
                  target="_blank"
                >
                  <i className={classes.socials + " fab fa-facebook"} />
                </Button>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                Julia Wei
                <br />
                <small className={classes.smallTitle}>Deez Nuts</small>
              </h4>
              <CardBody>
                <p className={classes.description}>
              ...
              <CardFooter className={classes.justifyCenter}>
                <Button
                  ...
                  color="transparent"
                  className={classes.margin5}
                  href="https://www.facebook.com/julia.wei.566"
                  target="_blank"
                >
                  <i className={classes.socials + " fab fa-facebook"} />
                </Button>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                Lucas Snarski
                <br />
                <small className={classes.smallTitle}>Port</small>
              </h4>
              <CardBody>
                <p className={classes.description}>
                  You can write here details about one of your team members. You
              ...
              <CardFooter className={classes.justifyCenter}>
                <Button
                  ...
                  color="transparent"
                  className={classes.margin5}
                  href="https://www.facebook.com/lucas.snarski"
                  target="_blank"
                >
                  <i className={classes.socials + " fab fa-facebook"} />
                </Button>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                Mike Smith
                <br />
                <small className={classes.smallTitle}>Disc Jockeys</small>
              </h4>
              <CardBody>
                <p className={classes.description}>
                  You can write here details about one of your team members. You
              ...
              <CardFooter className={classes.justifyCenter}>
                ...
                <Button
                  ...
                  color="transparent"
                  className={classes.margin5}
                  href="https://www.facebook.com/profile.php?id=585346130"
                  target="_blank"
                >
                  <i className={classes.socials + " fab fa-facebook"} />
                </Button>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                Tim Zabinsky
                <br />
                <small className={classes.smallTitle}>Mighty Hucks</small>
              </h4>
              <CardBody>
                <p className={classes.description}>
                  You can write here details about one of your team members. You
              ...
              <CardFooter className={classes.justifyCenter}>
                ...
                <Button
                  ...
                  color="transparent"
                  className={classes.margin5}
                  href="https://www.facebook.com/tim.zabinski"
                  target="_blank"
                >
                  <i className={classes.socials + " fab fa-facebook"} />
                </Button>
