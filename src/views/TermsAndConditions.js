...
const TermsAndConditions = () => {
  return (
    <div>
      ...
      <p>
        Forrest Waters is committed to ensuring that the app is as useful and
      ...
      <p>
        The kul-native app stores and processes personal data that you have
        ...
        features and it could mean that the kul-native app won’t work properly
        or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Forrest Waters
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Forrest
        Waters cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Forrest Waters cannot always take responsibility
        ...
        avail the Service, Forrest Waters cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Forrest Waters’s responsibility for your use of the app,
        ...
        make it available to you. Forrest Waters accepts no liability for any
      ...
      <p>
        ...
        using the app. Forrest Waters does not promise that it will always
      ...
      <p>These terms and conditions are effective as of 2020-11-19</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at forrestwaters@gmail.com.
      </p>{" "}
      <p>
